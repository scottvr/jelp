...
| (C) jelp-primed-useful  |  24 |  100.0% |     5.167 |       5.000 |       1.083 |         9085.7 |
...
| (C) jelp-primed-useful  |  24 |   87.5% |     2.833 |       3.000 |       0.250 |         7141.8 |
...
| (C) jelp-primed-useful  |  48 |   93.8% |     4.000 |       4.000 |       0.667 |         8113.8 |
...
| ------------ | ------------------: | -------------: | ------------: | -------------------: | -------------------: | --------------: | --------------- | ------------------ | ------------------- | ---------------: | ------------------: | -------------------: | ---------- | ------------ | ------------------------ |
| gpt-4.1-mini |                  24 |             24 |        100.0% |                0.000 |                0.000 |           2.313 | [0.000, 0.000]  | [-1.000, 0.500]    | [1.889, 2.834]      |            0.000 |               1.500 |                0.945 | yes        | no           | No net benefit currently |
| gpt-5-mini   |                  24 |             24 |        100.0% |               -4.167 |               -1.000 |           1.107 | [-16.67, 8.333] | [-2.000, -1.000]   | [0.970, 1.260]      |            25.00 |               1.000 |                0.290 | yes        | no           | No net benefit currently |
...
| ---------- | ------------------: | -------------: | ------------: | -------------------: | -------------------: | --------------: | --------------- | ------------------ | ------------------- | ---------------: | ------------------: | -------------------: | ---------- | ------------ | ------------------------ |
| all-models |                  48 |             48 |        100.0% |               -2.083 |               -1.000 |           1.563 | [-8.333, 4.167] | [-1.000, -1.000]   | [1.337, 1.831]      |            12.50 |               0.000 |                0.493 | yes        | no           | No net benefit currently |
...
| ------------ | ------------------------ | ------------------------ | --------------- | --------------: | --------------------: | ------ |
| gpt-4.1-mini | No net benefit currently | No net benefit currently | no              |           2.313 |                  1.75 | -      |
| gpt-5-mini   | No net benefit currently | No net benefit currently | no              |           1.107 |                  1.75 | -      |
| all-models   | No net benefit currently | No net benefit currently | no              |           1.563 |                  1.75 | -      |
...
- `success_delta_pp_obs=-2.083` vs threshold `>= 0.0`: `fail`; `success_ci_boot=[-8.333, 4.167]`
- `median_cmd_delta_obs=-1.000` vs threshold `<= -0.5`: `pass`; `median_cmd_ci_boot=[-1.000, -1.000]`
- `token_ratio_obs=1.563` vs threshold `<= 1.75`: `pass`; `token_ratio_ci_boot=[1.337, 1.831]`
...
- `token_ratio_obs=2.313` vs threshold `<= 1.75`: `fail`; `token_ratio_ci_boot=[1.889, 2.834]`
...
- observed pairs `24/24` (coverage `100.0%`)
- `success_delta_pp_obs=-4.167` vs threshold `>= 0.0`: `fail`; `success_ci_boot=[-16.67, 8.333]`
- `median_cmd_delta_obs=-1.000` vs threshold `<= -0.5`: `pass`; `median_cmd_ci_boot=[-2.000, -1.000]`
- `token_ratio_obs=1.107` vs threshold `<= 1.75`: `pass`; `token_ratio_ci_boot=[0.970, 1.260]`
- `ci_favorable` gate (`success_ci_low >= 0.0` and `cmd_ci_high <= -0.5`): `fail` (success part: `fail`, command part: `pass`)
